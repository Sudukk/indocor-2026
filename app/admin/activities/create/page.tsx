...
import { ArrowLeft, Loader2, Save, UploadCloud, ImageIcon, X } from "lucide-react";
    ...
    return (
        <div>
            <div className="mb-8">
                ...
                <p className="text-gray-500 mt-1">Lengkapi informasi dan upload foto kegiatan</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                required
                                placeholder="Contoh: 15 - 18 Agustus 2026"
                                className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-red focus:ring-2 focus:ring-red/20 outline-none transition-all"
                            />
                        </div>
                    </div>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 md:p-8 space-y-6">
                    ...
                    <ImageUploadField
                        label="Foto Utama Event"
                        value={form.image_main}
                        onChange={(path) => setForm((prev) => ({ ...prev, image_main: path }))}
                        required
                    />

                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-2">
                            Penjelasan Section 1
                        </label>
                        <textarea
                            name="section1_text"
                            value={form.section1_text}
                            onChange={handleChange}
                            rows={6}
                            placeholder="Tulis penjelasan kegiatan di section pertama... (bisa beberapa paragraf)"
                            className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-red focus:ring-2 focus:ring-red/20 outline-none transition-all resize-none"
                        />
                    </div>
                </div>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 md:p-8 space-y-6">
                    ...
                    <ImageUploadField
                        label="Foto Pendukung 1"
                        value={form.image_support1}
                        onChange={(path) => setForm((prev) => ({ ...prev, image_support1: path }))}
                    />

                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-2">
                            Penjelasan Section 2
                        </label>
                        <textarea
                            name="section2_text"
                            value={form.section2_text}
                            onChange={handleChange}
                            rows={6}
                            placeholder="Tulis penjelasan kegiatan di section kedua... (bisa beberapa paragraf)"
                            className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-red focus:ring-2 focus:ring-red/20 outline-none transition-all resize-none"
                        />
                    </div>
                </div>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 md:p-8 space-y-6">
                    ...
                    <ImageUploadField
                        label="Foto Pendukung 2"
                        value={form.image_support2}
                        onChange={(path) => setForm((prev) => ({ ...prev, image_support2: path }))}
                    />

                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-2">
                            Penjelasan Section 3
                        </label>
                        <textarea
                            name="section3_text"
                            value={form.section3_text}
                            onChange={handleChange}
                            rows={6}
                            placeholder="Tulis penjelasan kegiatan di section ketiga... (bisa beberapa paragraf)"
                            className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-red focus:ring-2 focus:ring-red/20 outline-none transition-all resize-none"
                        />
                    </div>
                </div>
